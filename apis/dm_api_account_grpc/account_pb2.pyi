...
class LoginRequest(Message):
    ...
    def ClearField(self, field_name: Literal["login", b"login", "password", b"password", "remember_me", b"remember_me"]) -> None: ...
...
class LoginResponse(Message):
    ...
    def HasField(self, field_name: Literal["user", b"user"]) -> bool: ...
    def ClearField(self, field_name: Literal["token", b"token", "user", b"user"]) -> None: ...
...
class LogoutRequest(Message):
    ...
    def ClearField(self, field_name: Literal["token", b"token"]) -> None: ...
...
class GetCurrentAccountResponse(Message):
    ...
    def HasField(self, field_name: Literal["user", b"user"]) -> bool: ...
    def ClearField(self, field_name: Literal["user", b"user"]) -> None: ...
...
class GetAccountsRequest(Message):
    ...
    def HasField(self, field_name: Literal["paging", b"paging"]) -> bool: ...
    def ClearField(self, field_name: Literal["paging", b"paging", "with_inactive", b"with_inactive"]) -> None: ...
...
class GetAccountsResponse(Message):
    ...
    def HasField(self, field_name: Literal["paging", b"paging"]) -> bool: ...
    def ClearField(self, field_name: Literal["accounts", b"accounts", "paging", b"paging"]) -> None: ...
...
class RegisterAccountResponse(Message):
    ...
    def ClearField(self, field_name: Literal["id", b"id", "login", b"login"]) -> None: ...
...
class RegisterAccountClientStreamResponse(Message):
    ...
    class Result(Message):
        ...
        def HasField(self, field_name: Literal["error", b"error", "id", b"id", "result", b"result"]) -> bool: ...
        def ClearField(self, field_name: Literal["error", b"error", "id", b"id", "login", b"login", "result", b"result"]) -> None: ...
...
class ActivateAccountRequest(Message):
    ...
    def ClearField(self, field_name: Literal["activation_token", b"activation_token"]) -> None: ...
...
class ResetAccountPasswordRequest(Message):
    ...
    def ClearField(self, field_name: Literal["email", b"email", "login", b"login"]) -> None: ...
...
class ChangeAccountPasswordRequest(Message):
    ...
    def HasField(self, field_name: Literal["token", b"token"]) -> bool: ...
    def ClearField(self, field_name: Literal["login", b"login", "new_password", b"new_password", "old_password", b"old_password", "token", b"token"]) -> None: ...
...
class UpdateAccountRequest(Message):
    ...
    def HasField(self, field_name: Literal["user_data", b"user_data"]) -> bool: ...
    def ClearField(self, field_name: Literal["token", b"token", "user_data", b"user_data"]) -> None: ...
...
class TimestampValue(Message):
    ...
    def ClearField(self, field_name: Literal["value", b"value"]) -> None: ...
...
class UserRating(Message):
    ...
    def ClearField(self, field_name: Literal["enabled", b"enabled", "quality", b"quality", "quantity", b"quantity"]) -> None: ...
...
class User(Message):
    ...
    def HasField(self, field_name: Literal["location", b"location", "medium_picture_url", b"medium_picture_url", "name", b"name", "online", b"online", "rating", b"rating", "registration", b"registration", "small_picture_url", b"small_picture_url", "status", b"status"]) -> bool: ...
    def ClearField(self, field_name: Literal["location", b"location", "login", b"login", "medium_picture_url", b"medium_picture_url", "name", b"name", "online", b"online", "rating", b"rating", "registration", b"registration", "roles", b"roles", "small_picture_url", b"small_picture_url", "status", b"status"]) -> None: ...
...
class UserUpdate(Message):
    ...
    def HasField(self, field_name: Literal["icq", b"icq", "info", b"info", "location", b"location", "name", b"name", "rating_disabled", b"rating_disabled", "skype", b"skype", "status", b"status", "user_settings", b"user_settings"]) -> bool: ...
    def ClearField(self, field_name: Literal["icq", b"icq", "info", b"info", "location", b"location", "name", b"name", "rating_disabled", b"rating_disabled", "skype", b"skype", "status", b"status", "user_settings", b"user_settings"]) -> None: ...
...
class UserSettings(Message):
    ...
    def HasField(self, field_name: Literal["paging_settings", b"paging_settings"]) -> bool: ...
    def ClearField(self, field_name: Literal["color_schema", b"color_schema", "nanny_greetings_message", b"nanny_greetings_message", "paging_settings", b"paging_settings"]) -> None: ...
...
class PagingQuery(Message):
    ...
    def HasField(self, field_name: Literal["number", b"number", "size", b"size", "skip", b"skip"]) -> bool: ...
    def ClearField(self, field_name: Literal["number", b"number", "size", b"size", "skip", b"skip"]) -> None: ...
...
class PagingResult(Message):
    ...
    def ClearField(self, field_name: Literal["current_page", b"current_page", "entity_number", b"entity_number", "page_size", b"page_size", "total_entities_count", b"total_entities_count", "total_pages_count", b"total_pages_count"]) -> None: ...
...
class PagingSettings(Message):
    ...
    def ClearField(self, field_name: Literal["comments_per_page", b"comments_per_page", "entities_per_page", b"entities_per_page", "messages_per_page", b"messages_per_page", "posts_per_page", b"posts_per_page", "topics_per_page", b"topics_per_page"]) -> None: ...
...
class UserEnvelope(Message):
    ...
    def HasField(self, field_name: Literal["metadata", b"metadata", "resource", b"resource"]) -> bool: ...
    def ClearField(self, field_name: Literal["metadata", b"metadata", "resource", b"resource"]) -> None: ...
...
class GetAccountsByLoginRequest(Message):
    ...
    def ClearField(self, field_name: Literal["login", b"login"]) -> None: ...
...
class GetAccountsByLoginResponse(Message):
    ...
    def HasField(self, field_name: Literal["error", b"error", "result", b"result", "user", b"user"]) -> bool: ...
    def ClearField(self, field_name: Literal["error", b"error", "login", b"login", "result", b"result", "user", b"user"]) -> None: ...
